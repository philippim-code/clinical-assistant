...
(function(){
  ...
  const RELEASE_NOTES=[
    ...
    '<li><strong>Interaction refinement</strong> improves launcher-card and Spark selection feedback while keeping motion restrained and optional.</li>',
  ...
  APPEARANCE_STYLESHEETS.forEach((href,index)=>{
    const ids=['appearanceOverhaulStyles','appearanceOverhaulDev2Styles','appearanceOverhaulDev3Styles','appearanceOverhaulDev4Styles','appearanceOverhaulDev5Styles','appearanceOverhaulDev6Styles'];
